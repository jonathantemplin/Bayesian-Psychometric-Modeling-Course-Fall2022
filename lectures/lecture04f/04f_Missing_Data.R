...
# Stan won't work with missing data: ======================================================

modelOrderedLogitNoMiss_syntax = "
data {
...
modelOrderedLogitNoMiss_stan = cmdstan_model(stan_file = write_stan_file(modelOrderedLogitNoMiss_syntax))
...
# Making stan work with missing data =======================================================================


# Ordered Logit with missing data (Multinomial/categorical distribution) Model Syntax =======================
...
save.image(file = "lecture04f.RData")
